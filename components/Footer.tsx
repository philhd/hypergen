...
const Footer = () => {
  return (
    <footer className="w-full py-12 bg-slate-950 border-t border-white/10">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Redefining the boundaries of artificial intelligence with breakthrough neural architecture.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} Hypergen AI. All rights reserved.
          </p>
